...
export const WEDDING_DATE = dayjs.tz("2027-03-27 14:00", "Asia/Seoul")
...
export const LOCATION = "경주 소노캄 웨딩홀"
export const LOCATION_ADDRESS = "경상북도 경주시 보문로 402-12 소노캄 경주"
...
export const BRIDE_FULLNAME = "김예령"
export const BRIDE_FIRSTNAME = "예령"
export const BRIDE_TITLE = "장녀"
export const BRIDE_FATHER = "김동만"
export const BRIDE_MOTHER = "박혜경"
...
export const GROOM_FULLNAME = "정순일"
export const GROOM_FIRSTNAME = "순일"
export const GROOM_TITLE = "장남"
export const GROOM_FATHER = "정광식"
export const GROOM_MOTHER = "박순양"
export const GROOM_INFO = [
  {
    relation: "신랑",
    name: GROOM_FULLNAME,
    phone: "010-2811-1108",
    account: "경남은행 20270327",
  }
]
